...
const ManageServices = () => {
    ...
    const handleDelete = id => {
        const url = `https://eerie-eyeballs-55193.herokuapp.com/services/${id}`;
        fetch(url, {
            method: 'DELETE'
        })
            .then(res => res.json())
    ...
    //     fetch("https://eerie-eyeballs-55193.herokuapp.com/myOrders", {
    //         method: "POST",
    ...
    return (
        <div className="my-5">
            <h2 className="text-center my-5 green-color fs-1">Manage All orders</h2>
